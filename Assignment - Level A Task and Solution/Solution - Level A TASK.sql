...
ORDER BY ot.TotalOrderCost DESC
...
JOIN
 HumanResources.Employee AS Manager ON Employee.OrganizationNode.GetAncestor(1) =
...
pp.PhoneNumberTypeID = (SELECT PhoneNumberTypeID FROM Person.PhoneNumberType
WHERE Name = 'Fax')
WHERE
